...
namespace lab_3.Migrations
{
    ...
    partial class CarServiceKpzContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("lab_3.Models.BodyType", b =>
                {
            ...
            modelBuilder.Entity("lab_3.Models.Car", b =>
                {
            ...
            modelBuilder.Entity("lab_3.Models.CarBrand", b =>
                {
            ...
            modelBuilder.Entity("lab_3.Models.CarModel", b =>
                {
                    b.Property<int>("CarModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("lab_3.Models.Color", b =>
                {
                    b.Property<int>("ColorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("lab_3.Models.Customer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("lab_3.Models.DriveType", b =>
                {
                    b.Property<int>("DriveTypeId")
                        .HasColumnType("int")
                        .HasColumnName("DriveTypeID");
            ...
            modelBuilder.Entity("lab_3.Models.EmployeePosition", b =>
                {
                    b.Property<int>("EmployeePositionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("lab_3.Models.EngineType", b =>
                {
                    b.Property<int>("EngineTypeId")
                        .HasColumnType("int")
                        .HasColumnName("EngineTypeID");
            ...
            modelBuilder.Entity("lab_3.Models.Part", b =>
                {
            ...
            modelBuilder.Entity("lab_3.Models.PartBrand", b =>
                {
                    b.Property<int>("PartBrandId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("lab_3.Models.PartInStation", b =>
                {
            ...
            modelBuilder.Entity("lab_3.Models.PartType", b =>
                {
                    b.Property<int>("PartTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("lab_3.Models.PaymentStatus", b =>
                {
            ...
            modelBuilder.Entity("lab_3.Models.ProvidedService", b =>
                {
            ...
            modelBuilder.Entity("lab_3.Models.RequiredPart", b =>
                {
            ...
            modelBuilder.Entity("lab_3.Models.Service", b =>
                {
            ...
            modelBuilder.Entity("lab_3.Models.ServiceType", b =>
                {
                    b.Property<int>("ServiceTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("lab_3.Models.Station", b =>
                {
                    b.Property<int>("StationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("lab_3.Models.SuspensionType", b =>
                {
                    b.Property<int>("SuspensionTypeId")
                        .HasColumnType("int")
                        .HasColumnName("SuspensionTypeID");
            ...
            modelBuilder.Entity("lab_3.Models.TransmissionType", b =>
                {
                    b.Property<int>("TransmissionTypeId")
                        .HasColumnType("int")
                        .HasColumnName("TransmissionTypeID");
            ...
            modelBuilder.Entity("lab_3.Models.Visit", b =>
                {
            ...
            modelBuilder.Entity("lab_3.Models.VisitService", b =>
                {
                    b.Property<int>("VisitServiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("lab_3.Models.VisitStatus", b =>
                {
                    b.Property<int>("VisitStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("lab_3.Models.Car", b =>
                {
                    b.HasOne("lab_3.Models.CarModel", "CarModel")
                        .WithMany("Cars")
                        .HasForeignKey("CarModelId")
                        .IsRequired()
                        .HasConstraintName("FK__Car__CarModelID__6C190EBB");

                    b.HasOne("lab_3.Models.Color", "Color")
                        .WithMany("Cars")
                        .HasForeignKey("ColorId")
                        .IsRequired()
                        .HasConstraintName("FK__Car__ColorID__6D0D32F4");

                    b.HasOne("lab_3.Models.Customer", "Customer")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("lab_3.Models.Employee", b =>
                {
                    b.HasOne("lab_3.Models.EmployeePosition", "EmployeePosition")
                        .WithMany("Employees")
                        .HasForeignKey("EmployeePositionId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK__Employee__Employ__08B54D69");

                    b.HasOne("lab_3.Models.Station", "Station")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("lab_3.Models.Part", b =>
                {
                    b.HasOne("lab_3.Models.PartBrand", "PartBrand")
                        .WithMany("Parts")
                        .HasForeignKey("PartBrandId")
                        .HasConstraintName("FK__Part__PartBrandI__787EE5A0");

                    b.HasOne("lab_3.Models.PartType", "PartType")
                        .WithMany("Parts")
            ...
            modelBuilder.Entity("lab_3.Models.PartInStation", b =>
                {
                    b.HasOne("lab_3.Models.Part", "Part")
            ...
            modelBuilder.Entity("lab_3.Models.ProvidedService", b =>
                {
                    b.HasOne("lab_3.Models.Employee", "Employee")
                        .WithMany("ProvidedServices")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK__ProvidedS__Emplo__2645B050");

                    b.HasOne("lab_3.Models.VisitService", "VisitService")
                        .WithOne("ProvidedService")
                        .HasForeignKey("lab_3.Models.ProvidedService", "VisitServiceId")
            ...
            modelBuilder.Entity("lab_3.Models.RequiredPart", b =>
                {
                    b.HasOne("lab_3.Models.PartInStation", "PartInStation")
                        .WithMany("RequiredParts")
                        .HasForeignKey("PartInStationId")
                        .IsRequired()
                        .HasConstraintName("FK__RequiredP__PartI__2A164134");

                    b.HasOne("lab_3.Models.ProvidedService", "ProvidedService")
                        .WithMany("RequiredParts")
            ...
            modelBuilder.Entity("lab_3.Models.Service", b =>
                {
                    b.HasOne("lab_3.Models.ServiceType", "ServiceType")
                        .WithMany("Services")
            ...
            modelBuilder.Entity("lab_3.Models.Visit", b =>
                {
                    ...
                    b.HasOne("lab_3.Models.PaymentStatus", "PaymentStatus")
                        .WithMany("Visits")
                        .HasForeignKey("PaymentStatusId")
                        .HasConstraintName("FK__Visit__PaymentSt__1EA48E88");

                    b.HasOne("lab_3.Models.VisitStatus", "VisitStatus")
                        .WithMany("Visits")
